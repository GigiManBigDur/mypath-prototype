...
const DEFAULT_STATE = {
  ...
  // real extracurriculars/experiences the student had ALREADY done before this app. AI-First
  // Onboarding Stage 1 removed the one-time Opportunity Finder prompt that used to gather this (it
  // will be absorbed into Stage 2's AI conversation instead) — the array itself, and the Profile
  // screen's own always-available editor for it, are untouched. Deliberately a separate array from
  // anything else this app tracks (opportunities/projects are things planned/started THROUGH this
  // app; these are real prior history) — included verbatim in the Stage 1 compiled profile so the
  // already-built AI features (Stage 2 suggestions, the chat assistant, Build Your Own) can
