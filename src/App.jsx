...
import AdmissionsPresentationScreen from './screens/AdmissionsPresentationScreen';
...
const SCREENS = {
  ...
  hub: HubScreen,
  survey: SurveyScreen,
  // Admissions Overview Presentation, Stage 1 (see CLAUDE.md) — a real, 10-module, beat-by-beat
  // presentation inserted right after the (now much-reduced) Survey, replacing the old one-line
  // "Quick context: ..." hub dialogue. New pre-hub sequence: Sign Up -> Survey -> this screen ->
  // the onboarding AI conversation -> Hub. Not reachable any other way (no hub tile, nothing else
  // navigates here) — same "mandatory, once, before the hub exists" shape Sign Up/Survey/the
  // conversation itself already have.
  admissionsPresentation: AdmissionsPresentationScreen,
