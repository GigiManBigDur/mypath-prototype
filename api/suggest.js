...
export default async function handler(req, res) {
  ...
  // most once per completed-task-with-outcome-note, so legitimate volume is naturally low (see
  // _rateLimit.js's own header for what this does and doesn't protect against).
